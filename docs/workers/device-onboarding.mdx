...
### Table of Contents
- [Create Account](/docs/device-onboarding#create-account)
- [Requirements](/docs/device-onboarding#requirements)
- [Set Up a New Worker](/docs/device-onboarding#set-up-a-new-worker)
- [App Guide](/docs/device-onboarding#app-guide)
  - [Workers Homepage](/docs/device-onboarding#workers-homepage)
  - [Device Status](/docs/device-onboarding#device-status)
  - [Readiness](/docs/device-onboarding#readiness)
  - [Transition Between States](/docs/device-onboarding#transition-between-states)
- [Troubleshoot](/docs/device-onboarding#troubleshoot)
