...
1. After your cluster deployment is complete, go to **View Cluster**.
   ...
   <Frame>
   ![](/images/docs/8cca6a4-deployed.png)
   </Frame>

2. On the cluster detail page, copy the **IDE Password** and click **Jupyter Notebook**.

   <Frame>
   ![](/images/docs/d5cb98d636f8405c7ca7d68c3874193ace1d25659639d19a69334f81474f0da7-traininmodel1.jpg)
   </Frame>

3. Enter your **IDE Password** you copied in the **Jupyter** password field.

   <Frame>
   ![](/images/docs/a07a40fb534a97f28398effc7d6cdf577779ca3f1f3e7d9739e2e0c001eae8a3-traininmodel8.jpg)
   </Frame>
...
5. In the **New** dropdown, select **Notebook**. It launches a new tab.
   ...
   <Frame>
   ![](/images/docs/3a9f10c224d4053617584b26f3d9f17d35d600c2209a1eecd95a7de7ea04b93c-traininmodel3.jpg)
   </Frame>
...
6. A new notebook will open in a new browser tab with a prompt to select a kernel. Choose **Python 3** for this example, then click **Select**.
   ...
   <Frame>
   ![](/images/docs/f15613067182fa62c950dc70e8c4de5827fdbf5aadc48726028d68ee226d4913-traininmodel6.jpg)
   </Frame>
...
7. Enter the code sample below into a cell and click **Run**.
   ...
   <Frame>
   ![](/images/docs/8b19d23cdbe0ff6004e93cbbe9089d0d13f816020a9cc1cad041e17ec157c028-traininmodel5.jpg)
   </Frame>
...
8. Enter the **Python command** below in a new cell to run the training model script. Then click **Run**.
   ...
   <Frame>
   ![](/images/docs/bc3157cc357f4fae0cb040e768fce9b6666bf761ccb4ee9395816bac85dad552-traininmodel11.jpg)
   </Frame>
...
<Frame>
![](/images/docs/249f44a-job_detail_2.png)
</Frame>
...
3. In the toolbar, click **Kernel** and select **Restart the kernel** from the dropdown. This updates the packages.
   ...
   <Frame>
   ![](/images/docs/d3ed96a94ffd83313a95cd28c0deb9b6cf498022b9d7d239d401b2cf99f001df-traininmodel4.jpg)
   </Frame>
