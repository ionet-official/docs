...
<Frame>
  <img
    src="/images/docs/0cb663c27871259fa1ac6f43021f38bad8eb71fcacc3f02b6f38d59e96f94c21-Dashboard5.jpg"
    alt=""
    className="mx-auto"
    style={{ width:"54%" }}
  />
...
_⚠ This formula is subject to change by the IOG Foundation to optimize incentives within the IO.net ecosystem._
