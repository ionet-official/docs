---
title: "IO Cloud Payments"
description: "This document describes how to add crypto wallets and pay using the wallet or with credit cards."
---
...
- [Fees](/docs/io-cloud-payments#fees)
- [Add Wallet for Crypto](/docs/io-cloud-payments#adding-a-wallet-for-crypto-payments)
- [Manage funds page](/docs/io-cloud-payments#manage-funds-page)
- [Deploy Cluster and Pay with \$IO Coin, USDC Crypto or Fiat](/docs/deploy-cluster-and-pay)
- [Extending Your Cluster and Pay with \$IO Coin or USDC Crypto](/docs/extending-your-cluster-and-pay)
...
1. Click on your icon in the upper right and select **Account Settings**.
   ...
   <Frame>
     ![](/images/docs/70d2b2ce74100be67815492648ce295031603b55055dd32341deedfe26d31c4e-step1.jpg)
   </Frame>
2. In Account Settings, find the **Solana Wallet Address** block and click the **Add Wallet** button.

   <Frame>
     ![](/images/docs/db926f4751a512ab40397490b23a21eb894b89fbf773967b30ba35909af8d940-step2.jpg)
   </Frame>
3. In the appearing popup, enter your new **Solana wallet address**
4. Click **Connect** to add the new address.

<Frame>
  ![](/images/docs/83dad721d308292a8b16bcfb03629f2b5ca9b840f8d3912dc829204d421ba78d-Step3.jpg)
</Frame>
...
1. Click on your icon in the upper right and select **Account Settings**.
   ...
   <Frame>
     ![](/images/docs/d7389af90d6fbe7644393c325b1f40424c849441a12b790e06f84052ccda726b-step1.jpg)
   </Frame>
2. In the **Aptos Wallet** section, click **Add Wallet.**

   <Frame>
     ![](/images/docs/a219cf94a71111549298dd846e3b2c137c6c071fdcb6373b145efa6a8ff07cd7-step2_-2.jpg)
   </Frame>
3. Enter your wallet address in the **Connect New Aptos Wallet** field and click **Connect**.

<Frame>
  ![](/images/docs/16c47b63befe7d1e33ed10829d257ccaa842c53b6c61b5abf7547bed0463fa1f-Step-3-2.jpg)
</Frame>
...
1. Underneath your first wallet address, find and click the **Add New Solana Wallet Address link**.
   ...
   <Frame>
     ![](/images/docs/1615a954e3ea6fab8691bbeb040c139790727acb4469d10c7c31da7361e9ee5e-Step4.jpg)
   </Frame>
...
3. Click **Connect** to add the new additional address.
   ...
   <Frame>
     ![](/images/docs/90a450125f796991010c06beeaed5165987154af57d59036bc52a5e87490aa19-Step5.jpg)
   </Frame>
4. Your new wallet will be successfully added to the IO ecosystem.

   <Frame>
     ![](/images/docs/443b974762b2971b3ef5dd39f3d1be0ec66377f96a64487f5b675322f93849f8-step6.jpg)
   </Frame>
...
<Frame>
  ![](/images/docs/62d593f062a7c7a2ddb9a9fe1777a5dceda1dbe3ea6f734824a6a3eb37ab3ff1-step7.jpg)
</Frame>
...
2. A **red Trash** icon will appear. Click on it to remove the selected wallet.
   ...
   <Frame>
     ![](/images/docs/e8843476d7904a13937d80241f93a9391b1460febd47e6d904cc406c7739aed9-step8.jpg)
   </Frame>
3. A pop-up will appear to double-check your action to ensure you want to remove the wallet.

   <Frame>
     ![](/images/docs/0c4ca16603944865b500a341ba4971bb6ad60d8f4a6c41f70d6b72436084f0ea-step9.jpg)
   </Frame>
...
<Frame>
  ![](/images/docs/565f4056259ac991c159ce65423f91f9e55b9098aa8ab3df1e132db28e37da54-step10.jpg)
</Frame>
