...
![Cc Inference Schema](/images/cc_inference_schema.png)
...
**Repository:** [github.com/ionet-official/attestation-agent](https://github.com/ionet-official/attestation-agent)
...
- [Quick Start](./quick-start.md) - Get started with confidential inference in 5 minutes
- [Verification Guide](./verification.md) - Deep dive into verifying attestation and signatures