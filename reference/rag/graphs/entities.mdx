...
| Method | Endpoint                                                                            | Description                               |
| ------ | ----------------------------------------------------------------------------------- | ----------------------------------------- |
| GET    | [/graphs/\{collection_id}/entities](/reference/rag/graphs/entities/list-graph-entities)                     | List entities (/[r2r-docs.sciphi.ai]/[1]) |
| POST   | [/graphs/\{collection_id}/entities](/reference/rag/graphs/entities/add-new-entities)                        | Create entity                             |
| GET    | [/graphs/\{collection_id}/entities/\{entity_id}](/reference/rag/graphs/entities/get-single-entity-details) | Get entity details                        |
