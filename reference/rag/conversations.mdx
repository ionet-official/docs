---
title: "Overview"
description: "The R2R Conversations API enables threaded, context-aware exchanges between users or AI agents. It offers endpoints to create, manage, and update conversations and messages, supporting branching dialogue, metadata attachment, and message history tracking."
---
