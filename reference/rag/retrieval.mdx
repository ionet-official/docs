...
| `POST` | [/retrieval/agent](/reference/rag/retrieval/agent-based-query-resolution) | Engage with a RAG-powered conversational agent with web search capabilities                    |
| `POST` | [/retrieval/completion](/reference/rag/retrieval/prompt-based-completion) | Generate text completions using language models                                                |
| `POST` | [/retrieval/embedding](/reference/rag/retrieval/generate-embedding)       | Generate embeddings for documents or text                                                      |
