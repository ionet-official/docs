---
title: "Overview"
description: "The R2R Indices API manages vector index structures that enable high-speed similarity search across chunks. It supports multiple index methods, configurable similarity measures, and concurrent building for optimized RAG retrieval performance."
---
