...
| GET    | [/collections/\{id}](/reference/rag/collections/get-collection-by-id)                                      | Get details of a specific collection                             |
...
| GET    | [/collections/\{id}/documents](/reference/rag/collections/list-documents-in-collection)                    | List documents in a collection                                   |
...
| POST   | [/collections/\{id}/extract](/reference/rag/collections/trigger-extraction-for-a-collection)               | Extract entities and relationships for all unprocessed documents |
| GET    | [/collections/\{id}/users](/reference/rag/collections/list-users-in-a-collection)                          | List users with access to a collection                           |
| POST   | [/collections/\{id}/users/\{user_id}](/reference/rag/collections/add-user-to-collection)                  | Add a user to a collection                                       |
| DELETE | [/collections/\{id}/users/\{user_id}](/reference/rag/collections/remove-user-from-collection)             | Remove a user from a collection                                  |
| GET    | [/collections/name/\{collection_name}](/reference/rag/collections/get-collection-by-name)                 | Get collection by name                                           |
