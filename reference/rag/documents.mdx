...
| `GET`    | [/documents//chunks](/reference/rag/documents/get-document-chunks)                | List the text _Chunks_ generated from a document’s content.              |
...
| `GET`    | [/documents//entities](/reference/rag/documents/get-extracted-entities)           | List _Entities_ identified within a document.                            |
| `GET`    | [/documents//relationship](/reference/rag/documents/get-relationships)            | List _Relationships_ identified within a document.                       |
