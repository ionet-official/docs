---
title: "Overview"
description: "The R2R Documents API handles ingestion, management, and enrichment of digital content. It enables transforming files, text, and media into structured, searchable knowledge objects for RAG, semantic retrieval, and AI-driven workflows."
---
...
| `GET`    | [/documents/{id}/chunks](/reference/rag/documents/get-document-chunks)                | List the text _Chunks_ generated from a document’s content.              |
...
| `GET`    | [/documents/{id}/entities](/reference/rag/documents/get-extracted-entities)           | List _Entities_ identified within a document.                            |
| `GET`    | [/documents/{id}/relationship](/reference/rag/documents/get-relationships)            | List _Relationships_ identified within a document.                       |
