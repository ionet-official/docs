...
description: "The R2R Streaming Retrieval API provides real-time streaming for RAG and agent interactions, emitting structured events such as search results, reasoning steps, and final responses. It enables interactive, low-latency experiences for AI-driven applications."
---
