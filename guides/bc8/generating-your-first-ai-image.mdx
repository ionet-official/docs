...
6. View Previously Created Prompts:
   ...
   To see the details of a prompt you have generated, simply click on it. A pop-up will appear with the generated result. The pop-up contains the following information and options:
    - Generated Image
