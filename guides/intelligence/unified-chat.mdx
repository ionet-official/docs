...
2. Navigate to [**Unified Chat**](https://ai.io.net/ai/re) within **IO Intelligence**.
...
- Choose the desired output type from **Settings** before sending your prompt, or simply describe what you want in the chat.
...
Each chat interaction consumes tokens, which are **automatically refreshed daily**. If you reach your daily token limit and need additional usage, you can purchase **IO Credits** to continue without interruption:
...
For more details, refer to the [IO Credits Documentation](/guides/payment/io-credits)\
.