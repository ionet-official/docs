...
<Tabs>
  <Tab title="Option A - Use a Built-in Dataset">
    ...
    <Frame>
      ![TaaS Select Dataset - Base Dataset](/images/docs/io-intelligence/TaaS/TaaS_SelectDataset_BaseDataset.png)
    </Frame>
  </Tab>
  <Tab title="Option B - Link a Custom Dataset">
    ...
    <Frame>
      ![TaaS Select Dataset - Custom Dataset](/images/docs/io-intelligence/TaaS/TaaS_SelectDataset_CustomDataset.png)
    </Frame>
    <Tip>
