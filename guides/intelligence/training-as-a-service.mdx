...
The _Training Model_ form is designed to guide you through the setup process, step by step.
...
<Tabs>
  ...
  <Tab title="Option B - Link a Hugging Face Model">
    ...
    4. If the repository is **private** or **invalid**, a prompt will request your _Hugging Face Token_ with the message: "_The repository is private or does not exist. Provide an HF Token"._ For additional guidance, see [**How to get your Hugging Face Token**](https://huggingface.co/docs/hub/en/security-tokens).
...
<Tabs>
  ...
  <Tab title="Option B - Link a Custom Dataset">
    ...
    <Tip>
      Refer to the documentation link provided on top of the **_Configuration_** section for more details.
    </Tip>
  </Tab>
</Tabs>
...
<Tabs>
  <Tab title="Option A - Simple Creating">
    ...
    <Frame>
      ![Taa S Simple Training Style Pn](/images/docs/io-intelligence/TaaS/TaaS_SimpleTrainingStyle.png)
    </Frame>
  </Tab>
  <Tab title="Option B - Advanced Creating">
    ...
    <Frame>
      ![Taa S Select Training Style Temp Pn](/images/docs/io-intelligence/TaaS/TaaS_SelectTrainingStyle_Temp.png)
    </Frame>
  </Tab>
</Tabs>
...
The following sections can be viewed in the **_Training Dashboard_**.
...
Click on a job from the dashboard to open its **_Job Details_**. This provides everything you need to track and manage your model training in real time.
...
**_Training Logs_** provide visibility into what occurs behind the scenes during the model training process. They contain a detailed list of steps, events, and status updates throughout the job’s lifecycle, making them especially useful for debugging, monitoring, or maintaining transparency.
