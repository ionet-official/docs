...
<Frame>
  <img
    src="/images/docs/554f4af-Step2.jpg"
    alt=""
    className="mx-auto"
    style={{ width:"75%" }}
  />
...
5. To set the time zone, click on the dropdown menu and select the desired time zone. Click **Confirm**. All date and time information is then displayed in the selected time zone. If you don't define this field, the default timezone is UTC.
   ...
   <Frame>
     <img
       src="/images/docs/36597c0e5a0022d45ca335a265244545ab0acedb62c7c32f90f8f60db52aec12-Group_36.jpg"
       alt=""
       className="mx-auto"
       style={{ width:"81%" }}
     />
...
<Frame caption="Image is part of complete Terms of Service">
  ![](/images/docs/51027adc04f73efc8943dd28dca9fe2c0d31c1ca0165bdcbe09212571c6878c5-Step8.jpg)
</Frame>
