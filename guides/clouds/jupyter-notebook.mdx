...
1. After your cluster deployment is complete, go to **View Cluster**.
   ...
   <Frame>
     <img
       src="/images/docs/8cca6a4-deployed.png"
       alt=""
       className="mx-auto"
       style={{ width:"66%" }}
     />
...
2. On the cluster detail page, copy the **IDE Password** and click **Jupyter Notebook**.
   ...
   <Frame>
     <img
       src="/images/docs/d5cb98d636f8405c7ca7d68c3874193ace1d25659639d19a69334f81474f0da7-traininmodel1.jpg"
       alt=""
       className="mx-auto"
       style={{ width:"68%" }}
     />
...
3. Enter your **IDE Password** you copied in the **Jupyter** password field.
   ...
   <Frame>
     <img
       src="/images/docs/a07a40fb534a97f28398effc7d6cdf577779ca3f1f3e7d9739e2e0c001eae8a3-traininmodel8.jpg"
       alt=""
       className="mx-auto"
       style={{ width:"55%" }}
     />
...
4. Click **File** to create a new Python Notebook.
   ...
   <Frame>
     ![](/images/docs/27734160a29b3143229bee1f734a58f10457efe4e4cbcb9eeed9ff6b3d5e3fe6-traininmodel2.jpg)
   </Frame>
5. In the **New** dropdown, select **Notebook**. It launches a new tab.

   <Frame>
     <img
       src="/images/docs/3a9f10c224d4053617584b26f3d9f17d35d600c2209a1eecd95a7de7ea04b93c-traininmodel3.jpg"
       alt=""
       className="mx-auto"
       style={{ width:"67%" }}
     />
...
6. A new notebook will open in a new browser tab with a prompt to select a kernel. Choose **Python 3** for this example, then click **Select**.
   ...
   <Frame>
     <img
       src="/images/docs/f15613067182fa62c950dc70e8c4de5827fdbf5aadc48726028d68ee226d4913-traininmodel6.jpg"
       alt=""
       className="mx-auto"
       style={{ width:"71%" }}
     />
...
7. Enter the code sample below into a cell and click **Run**.
   ...
   <Frame>
     <img
       src="/images/docs/8b19d23cdbe0ff6004e93cbbe9089d0d13f816020a9cc1cad041e17ec157c028-traininmodel5.jpg"
       alt=""
       className="mx-auto"
       style={{ width:"77%" }}
     />
...
8. Enter the **Python command** below in a new cell to run the training model script. Then click **Run**.
   ...
   <Frame>
     <img
       src="/images/docs/bc3157cc357f4fae0cb040e768fce9b6666bf761ccb4ee9395816bac85dad552-traininmodel11.jpg"
       alt=""
       className="mx-auto"
       style={{ width:"75%" }}
     />
...
1. Return to your cluster. On the cluster detail page, copy the **IDE Password** and click **Ray Dashboard**.
   ...
   <Frame>
     ![](/images/docs/73bbddca679bf39b2af899a2083e4f157cdeb9b9210f98d20606ef5e071dfa9b-traininmodel9.jpg)
   </Frame>
2. In the password field, enter your password. Click **View All Jobs**. Here, you can see that your job is running.

   <Frame>
     ![](/images/docs/8fdf7fd52bfcbcb6d0387a183eebbc7f18aed5b2eb01451a2c7ad9114aa53210-traininmodel7.jpg)
   </Frame>
3. You can also check this in io.net by going to **Clusters** \> **select your cluster** \> click an **IO Worker** \> **Jobs**.

<Frame>
  <img
    src="/images/docs/249f44a-job_detail_2.png"
    alt=""
    className="mx-auto"
    style={{ width:"49%" }}
  />
...
3. In the toolbar, click **Kernel** and select **Restart the kernel** from the dropdown. This updates the packages.
   ...
   <Frame>
     <img
       src="/images/docs/d3ed96a94ffd83313a95cd28c0deb9b6cf498022b9d7d239d401b2cf99f001df-traininmodel4.jpg"
       alt=""
       className="mx-auto"
       style={{ width:"67%" }}
     />
