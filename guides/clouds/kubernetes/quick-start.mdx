---
title: "Quick Start: Hello World with HTTPS"
description: "Deploy a Kubernetes Hello World application with HTTPS using Ingress, ExternalDNS, and cert-manager, and expose it securely to the internet step by step."
---
