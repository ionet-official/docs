...
description: "Instantly deploy GPU accelerated virtual machines designed for AI and ML workloads. Configure, launch, and manage your compute clusters. CPUs are included with every instance."
...
<Frame>
  ![IO Cloud VM Summary Pn](/images/docs/cloud_vm_on_demand/IOCloud_VM_Summary.png)
</Frame>
