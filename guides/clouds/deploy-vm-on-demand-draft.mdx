...
In this step, you can personalize your deployment by assigning a **cluster name** and configuring **network services**.
...
Network services allow you to expose specific ports on your cluster that are necessary for your applications or workflows. These ports enable external access to services running inside your virtual machine, such as APIs, web applications, or databases.
