...
<iframe width="100%" height="480" src="https://www.youtube.com/embed/7jc3dYbiiUs" title="IO Worker Guide for MacOS" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen />
...
<Frame>
  <img
    src="/images/docs/1c29ed6d34b2f9bbc8ab80f43279d2872964c560f867a81530e82ee76c6519f3-Step0.jpg"
    alt=""
    className="mx-auto"
    style={{ width:"83%" }}
  />
...
<Frame>
  <img
    src="/images/docs/de29df40f9a632af89c7cafd95f4acb332657550aca5bc1b3630225034a6453b-Step1.jpg"
    alt=""
    className="mx-auto"
    style={{ width:"62%" }}
  />
...
<Frame>
  <img
    src="/images/docs/4ab2791afa1784c65f0b291076f9e8c0f91ca5e8f4fffe7fb922c26c352d19e2-Step2.jpg"
    alt=""
    className="mx-auto"
    style={{ width:"69%" }}
  />
...
<Frame>
  <img
    src="/images/docs/5274db0357e3ae99cfc95b57f3f1aa9c2af8cc906d358b53eaf857dac33a7ce1-Step3.jpg"
    alt=""
    className="mx-auto"
    style={{ width:"60%" }}
  />
...
<Frame>
  <img
    src="/images/docs/560a01163ca32f581e247537775cc0996388c39442b09a3ff49f97c836b263db-Step4.jpg"
    alt=""
    className="mx-auto"
    style={{ width:"85%" }}
  />
...
<Frame>
  <img
    src="/images/docs/a757734d9ac6926db17891cada2e623939bb28c16ed646f75837aeeb4ba7cc08-Step5.jpg"
    alt=""
    className="mx-auto"
    style={{ width:"71%" }}
  />
...
1. Open the Terminal through **Launchpad**
   ...
   **Terminal** is a tool on your computer that lets you type in commands to tell the computer what to do. Instead of clicking on things with a mouse, you write instructions, and the computer follows them. It's like talking directly to your computer using text.
   ...
   <Frame>
     <img
       src="/images/docs/3291b8cd2dda2294bc83c86b27ace24b4f14975f3736e73f954885e03ea562c4-Step7.jpg"
       alt=""
       className="mx-auto"
       style={{ width:"64%" }}
     />
