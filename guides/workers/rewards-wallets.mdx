...
Additionally, the Proof of Work (PoW) [mechanism underpinning our ecosystem](/guides/workers/prof-of-compute) ensures that each transaction contributes to the network's security and integrity, further incentivizing the use of \$IO tokens within the platform.
...
1. Click on your icon in the upper right and select **Account Settings.**
   ...
   <Frame>
     <img
       src="/images/docs/6fbcce6-account_settings.png"
       alt=""
       className="mx-auto"
       style={{ width:"53%" }}
     />
...
2. In the upper-right of the screen, click USDC.
   ...
   <Frame>
     <img
       src="/images/docs/412226a-ClickRewards.png"
       alt=""
       className="mx-auto"
       style={{ width:"79%" }}
     />
...
<Frame>
  <img
    src="/images/docs/c73dafb-EarningTab.png"
    alt=""
    className="mx-auto"
    style={{ width:"54%" }}
  />
