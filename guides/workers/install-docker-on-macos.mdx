...
<iframe width="100%" height="480" src="https://www.youtube.com/embed/EIbheOuHpOI" title="Docker Guide for MacOS" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen />
...
<Frame>
  <img
    src="/images/docs/6cde349-Step2.jpg"
    alt=""
    className="mx-auto"
    style={{ width:"63%" }}
  />
...
<Frame>
  <img
    src="/images/docs/4eda55c186520c2223b78563edbbb047033d956cd780f898bb143b0d34b34e4c-Step3.jpg"
    alt=""
    className="mx-auto"
    style={{ width:"73%" }}
  />
...
<Frame>
  <img
    src="/images/docs/7acc67f5656643749054e5dd9f6a39772cf8f7348f903cbbb925d83cc0f28c3b-Step4.jpg"
    alt=""
    className="mx-auto"
    style={{ width:"64%" }}
  />
...
<Frame>
  <img
    src="/images/docs/e901826dcc950343214ce2a5f06d6e6bc757b49adcfc715a8f143ddf8eb29ebc-Step5mac.jpeg"
    alt=""
    className="mx-auto"
    style={{ width:"47%" }}
  />
...
2. Go to **Resources** on the left nav.
   ...
   <Frame>
     <img
       src="/images/docs/09b563bbd55cf92dc1979014994315fd6c16510df311303f8e2eb10436ed98d0-IO_docker_resources_left_nav.png"
       alt=""
       className="mx-auto"
       style={{ width:"70%" }}
     />
