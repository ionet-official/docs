...
- [Troubleshoot Docker Installation](#troubleshoot-docker-installation)
- [Stop the Platform](#stop-the-platform)
- [Restart the Platform](#restart-the-platform)
- [Windows Uptime](#windows-uptime)
- [Fixing the "Docker Desktop - Unexpected WSL error" in Windows](#fixing-the-docker-desktop---unexpected-wsl-error-in-windows)
...
> ❗️ Verify that you're not running two instances of io-worker-vc.
...
<img
  src="/images/docs/63989d6-UseCases-DockerWSL.jpg"
  alt="63989d6 Use Cases Docker WSL Jp"
  title="63989d6 Use Cases Docker WSL Jp"
  className="mx-auto"
  style={{ width:"82%" }}
/>
...
2. **Enable Hyper-V Feature**: Hyper-V is a virtualization technology tool that needs to be enabled in Windows. To check if Hyper-V is enabled, you can use the Windows Features dialog via Search:
   ...
   <img
     src="/images/docs/6d49f4e-UseCases-DockerWSL-2.jpg"
     alt="6d49f4e Use Cases Docker WSL 2 Jp"
     title="6d49f4e Use Cases Docker WSL 2 Jp"
     className="mx-auto"
     style={{ width:"72%" }}
   />
   ...
   <img
     src="/images/docs/f2f47e7-UseCases-DockerWSL-3.jpg"
     alt="F2f47e7 Use Cases Docker WSL 3 Jp"
     title="F2f47e7 Use Cases Docker WSL 3 Jp"
     className="mx-auto"
     style={{ width:"63%" }}
   />
