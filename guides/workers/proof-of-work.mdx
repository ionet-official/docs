...
1. Users can directly see on their device page whether their device is **Verified** or **Not Verified**:
   ...
   <Frame>
     <img
       src="/images/docs/8a91d5629ff97056ef80a9aa4c49a25f068ace0e8a44c4feee85b4f0bf3fc440-NotVerified.jpg"
       alt=""
       className="mx-auto"
       style={{ width:"60%" }}
     />
   ...
   <Frame>
     <img
       src="/images/docs/df74e13116c0c16daaa0390eafe3fb9ff84a4b9b9059548079b81bed315ecd51-NotVerifiedYet.jpg"
       alt=""
       className="mx-auto"
       style={{ width:"60%" }}
     />
   ...
   <Frame>
     <img
       src="/images/docs/9361f3a9e96e697420f04a1c38092f1f6e854341ebae4cabcab6eb3f57646813-VerFailed.jpg"
       alt=""
       className="mx-auto"
       style={{ width:"62%" }}
     />
...
<Frame>
  <img
    src="/images/docs/577cac763d88f4e1e94fd036b27fcbed43468457d4d368bc3cc73f33b8b03b29-pow.jpg"
    alt=""
    className="mx-auto"
    style={{ width:"58%" }}
  />
