...
<iframe width="100%" height="480" src="https://www.youtube.com/embed/eHep0MjVnIY" title="IO Worker Guide for Windows" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen />
...
<Frame>
  <img
    src="/images/docs/ad230e1344d7b2815045e36b565055d9b76b3bc9be3971c8dfe55a1aeec51a18-Step1.jpg"
    alt=""
    className="mx-auto"
    style={{ width:"61%" }}
  />
...
<Frame>
  <img
    src="/images/docs/352f11e1cce13ad3a66154afddaff6e05886432951baefe131f88956107404b9-Step2.jpg"
    alt=""
    className="mx-auto"
    style={{ width:"66%" }}
  />
...
<Frame>
  <img
    src="/images/docs/d45c3842aeb35ce8e794d4587595775820edc84b5f64377d2b506b6dc3d35ec2-Step3.jpg"
    alt=""
    className="mx-auto"
    style={{ width:"65%" }}
  />
...
<Frame>
  <img
    src="/images/docs/fa15e9bcea705360a6f26c50fb9e7d9c5b6f4a4b59014312407edfe16df677b1-Step4.jpg"
    alt=""
    className="mx-auto"
    style={{ width:"86%" }}
  />
...
<Frame>
  <img
    src="/images/docs/dfc41c05dde812a2168b7ca61a35139b9900598b94a8e95ade990910ac420a71-Step5.jpg"
    alt=""
    className="mx-auto"
    style={{ width:"80%" }}
  />
...
<Frame>
  <img
    src="/images/docs/5f74617cc09868a7db5d77f3eff61fa1ebf646d81a3470feebc6b8be0d96aff3-Step6.jpg"
    alt=""
    className="mx-auto"
    style={{ width:"77%" }}
  />
...
<Frame>
  <img
    src="/images/docs/a3ae8239f7c4796ac196d0dce63d1c92a3c0a1105911602b4d492a3d17825902-Step7.jpg"
    alt=""
    className="mx-auto"
    style={{ width:"85%" }}
  />
...
2. **Open IO Binary file into Terminal**
   ...
   **Terminal** is a tool on your computer that allows you enter commands to tell the computer what to do. Instead of clicking on elements with a mouse, you write instructions, and the computer follows them. It's like talking directly to your computer using text.
   - Click the **Start Menu** icon, then find and select the **Terminal** app from the popup menu.
     ...
     <Frame>
       <img
         src="/images/docs/90b9d15b93b4e634149cdf0c17d1590945ae783e3cd52b299769aeaa1683adb2-Step9.jpg"
         alt=""
         className="mx-auto"
         style={{ width:"84%" }}
       />
