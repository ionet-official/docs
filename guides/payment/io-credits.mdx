...
1. On the _Navigation Bar_, click **Buy IO Credits** and A pop-up window will appear.

   <Frame>
     ![IO Credits Nav Bar](/images/docs/payments/io-credits/IOCredits_NavBar.png)
   </Frame>
   <Frame>
     ![IO Credits Buy Pop Up](/images/docs/payments/io-credits/IOCredits_BuyPopUp.png)
   </Frame>
...
<Frame>
  ![IO Credits Withdrawal Pop Up](/images/docs/payments/io-credits/IOCredits_WithdrawalPopUp.png)
</Frame>
