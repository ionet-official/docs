...
<Frame>
  <img
    src="/images/docs/502ab1208d9069e54ffe6df378a938985371d05675f39ed650cc77cd824f24eb-add_coins_5.png"
    alt=""
    className="mx-auto"
    style={{ width:"69%" }}
  />
...
1. If you have a wallet, Spherepay may detect it. Scroll to browse and **select your wallet** if undetected. (Image below is a truncated list).
   ...
   <Frame>
     <img
       src="/images/docs/0c93e88ecc886e4adecf8e1509dad5977f7c51efab7597d90706e3a64fb72eb0-add_coins_7.png"
       alt=""
       className="mx-auto"
       style={{ width:"72%" }}
     />
...
1. Complete the steps to deploy a cluster, and on the final Summary step, select **Pay with USDC**.
   ...
   <Frame>
     <img
       src="/images/docs/5f647aebf22141287577b77e775cbb62b9314050ac18ae8fffa1bf9b10457779-add_coins_1.png"
       alt=""
       className="mx-auto"
       style={{ width:"86%" }}
     />
   ...
   <Frame>
     <img
       src="/images/docs/35a166e7204074a2364b05202b239ed35173591923352932748b3398e804a52c-add_coins_2.png"
       alt=""
       className="mx-auto"
       style={{ width:"80%" }}
     />
...
3. In the **Payment Currency** dialog, you select **USDC** (via Sphere Pay). After selecting your payment method, click **Confirm Method**.
   ...
   <Frame>
     <img
       src="/images/docs/37cea4cb81a51a586edcdb76889ba6c0140a74fe531e96b4bfb08c2612b75271-add_coins_4.png"
       alt=""
       className="mx-auto"
       style={{ width:"73%" }}
     />
...
4. On the **Set Amount** dialog, you can select Custom and enter any amount, or select the values to the right: **20, 100, 200, or 400** and click **Confirm Amount** and you are redirected to Spherepay to complete the transaction.
   ...
   <Frame>
     <img
       src="/images/docs/2f4b602752f8f614c3accf803bfc1b601f69d19acb9f8818e9ca2816cd6c35b1-add_coins_5.png"
       alt=""
       className="mx-auto"
       style={{ width:"69%" }}
     />
...
1. If you have a wallet, Spherepay may detect it. Scroll to browse and **select your wallet** if undetected. (Image below is a truncated list).
   ...
   <Frame>
     <img
       src="/images/docs/639f447b4917c7dbd650c11b8ef28e1c6f25fac4133556ed80c3c301f69f84de-add_coins_7.png"
       alt=""
       className="mx-auto"
       style={{ width:"68%" }}
     />
...
2. Click **Connect**.
   ...
   <Frame>
     <img
       src="/images/docs/9630e0a99462cffe6cf9771a2caabc28e175826dcd6b2e31f4ef9b24471ff82c-add_coins_8.png"
       alt=""
       className="mx-auto"
       style={{ width:"79%" }}
     />
...
1. Complete the steps to deploy a cluster, and on the final Summary step, select **Pay with USDC**.
   ...
   <Frame>
     <img
       src="/images/docs/c10eb6f0ae716462e384ebfcf4e02e71b21a2fe7b025df53aa78b0e6d0d487b2-add_coins_1.png"
       alt=""
       className="mx-auto"
       style={{ width:"84%" }}
     />
   ...
   <Frame>
     <img
       src="/images/docs/b87cc3f77e4b79fe8b39ab8d3afcf81e3f6a389b580ac8759039e64253c80b99-add_coins_2.png"
       alt=""
       className="mx-auto"
       style={{ width:"77%" }}
     />
...
2. At the end of the deploy process, click **Click to pay** button. Please note that if payment isn't completed **within 20 minutes**, the cluster creation session will end, and the **cluster will be destroye**d. You'll then be redirected to the previous step to confirm the details and create the cluster again.
   ...
   <Frame>
     <img
       src="/images/docs/1c84018fd00437ca90431f17e15aa788fdb9de5136f67614ac15b842b4044d7c-add_coins_3.png"
       alt=""
       className="mx-auto"
       style={{ width:"88%" }}
     />
...
3. In the **Payment Currency** dialog, you select **USD** (Credit/Debit card). After selecting your payment method, click **Confirm Method**.
   ...
   <Frame>
     <img
       src="/images/docs/a27a97254d722517a06a243e3d364921481a2e582e44f63dc41e4a2b9307d51c-add_coins_4.png"
       alt=""
       className="mx-auto"
       style={{ width:"75%" }}
     />
...
4. On the **Set Amount** dialog, you can select Custom and enter any amount, or select the values to the right: **20, 100, 200, or 400** and click **Confirm Amount** and you are redirected to **Stripe** to complete the transaction.
   ...
   <Frame>
     <img
       src="/images/docs/1d597e377bc18bef4fec734d9da9d128b35ca620e85f3f7fa110a294d9698b73-add_coins_5.png"
       alt=""
       className="mx-auto"
       style={{ width:"68%" }}
     />
...
5. Select **Card** in the Payment method section. Enter your credit card information and click Pay.
   ...
   <Frame>
     <img
       src="/images/docs/3820b6b2c85ffb8887d5cc1be40db85189814e48d3147bcdf4aa7707d8f1a6a8-add_coins_6.jpg"
       alt=""
       className="mx-auto"
       style={{ width:"79%" }}
     />
...
6. After your payment is processed, a confirmation appears.
   ...
   <Frame>
     <img
       src="/images/docs/0ba8d33-pay63.jpeg"
       alt=""
       className="mx-auto"
       style={{ width:"78%" }}
     />
...
7. Return to the tab with your cluster. Payment Verified is checked and the cluster is in the **deployment process**. Click **View Cluster** to view the details of your deployed cluster.
   ...
   <Frame>
     <img
       src="/images/docs/9878f80404738c8a49501a30f9d73fb5632db7428a57ef68d2684d32b2184a74-add_coins_9.png"
       alt=""
       className="mx-auto"
       style={{ width:"91%" }}
     />
