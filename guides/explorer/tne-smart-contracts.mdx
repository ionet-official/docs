...
description: "Learn how smart contracts manage booking, payments, extensions, compute tracking, refunds, and earnings within the IO Network. This guide explains each on-chain event, from creating a cluster to final IO Coin settlement, ensuring full transparency and auditability."
hidden: true
---
