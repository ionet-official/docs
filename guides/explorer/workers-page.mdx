---
title: "Workers"
description: "The Workers tab provides a public overview of all devices connected to the network, along with real-time metrics on active hires. This allows users to gain valuable insights into the current network status and the demand for computing power."
---
...
<Frame>
  <img
    src="/images/docs/6498c2004f6373ccaa15602d92bd8a6341ffaa95bb3ca0b8620620d750e9501f-worker3.jpg"
    alt=""
    className="mx-auto"
    style={{ width:"90%" }}
  />
...
<Frame>
  <img
    src="/images/docs/3f2a6dc-step7_1.jpeg"
    alt=""
    className="mx-auto"
    style={{ width:"68%" }}
  />
...
<Frame>
  <img
    src="/images/docs/022f0d148e218cf8d6799c82221df00c5c411d6041c30737e85a3f4ad48ea2be-Step9.jpg"
    alt=""
    className="mx-auto"
    style={{ width:"60%" }}
  />
