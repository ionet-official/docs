---
title: "Inferences"
description: "The Inferences tab provides a public overview of all transactions conducted within the network, along with real-time metrics for these transactions."
---
