...
<Frame>
  <img
    src="/images/docs/2028ed1c84e473894e252943b59ffba46c5d276c4c76d434de692c2769465f47-st3.png"
    alt=""
    className="mx-auto"
    style={{ width:"84%" }}
  />
...
2. Click **Connect Crypto Wallet** on the right side on the **Staking** page.
   ...
   <Frame>
     <img
       src="/images/docs/73c37acd8a831a1b1b3c7ecb533fccfa12cbb95e7fa3506a69c98ae8078d7318-Group_43.jpg"
       alt=""
       className="mx-auto"
       style={{ width:"63%" }}
     />
...
3. Select your crypto wallet in the pop-up window. Please note that this wallet can be different from the wallet you have associated with your account. For example, see [Solana Wallet](/docs/solana) to learn more.
   ...
   <Frame>
     <img
       src="/images/docs/d194af3ed5f29a379a4c703e113b1e47a46c81e13ca47bc8795fb7bc2697988d-stkng3.jpg"
       alt=""
       className="mx-auto"
       style={{ width:"60%" }}
     />
...
4. The **Phantom** wallet prompts you to connect with IO. Click **Connect** to proceed.
   ...
   <Frame>
     <img
       src="/images/docs/ff288bef2dfd0bf8382ed95a5fe6e64bb4bc782c45cad42f44db40aef6f61810-stkng5.jpg"
       alt=""
       className="mx-auto"
       style={{ width:"50%" }}
     />
   ...
   <Frame>
     <img
       src="/images/docs/2d2dcf8-stkng6.jpeg"
       alt=""
       className="mx-auto"
       style={{ width:"51%" }}
     />
...
<Frame>
  <img
    src="/images/docs/c590fffca7d75fe474bf7a4950bf7e856a5b2b2dcde6a21ce2fcc828a2732e35-stkng9.jpg"
    alt=""
    className="mx-auto"
    style={{ width:"55%" }}
  />
