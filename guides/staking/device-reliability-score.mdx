---
title: "Device Reliability Score"
description: "The Device Reliability Score is a key metric that helps both worker providers and co-stakers assess the reliability and trustworthiness of a device in the staking network. It reflects how consistently the device performs and whether it meets IO.net’s technical and uptime requirements."
---
...
1. **Filter by Reliability:** In the **Co-Staking Marketplace**, you can filter offers based on the **Device Reliability Score**. This helps you sort and prioritize staking offers that come from more reliable devices.
   ...
   <Frame>
     <img
       src="/images/docs/529dcdfd34a1a26558f1561424fd410d1378ef49855b8167355f0d716d4ef50b-Device_Reliability_Score.jpeg"
       alt=""
       className="mx-auto"
       style={{ width:"65%" }}
     />
...
2. **Evaluate the Risk:** A device with a **low reliability score** might be riskier for your investment. Be sure to assess whether the offered reward percentage justifies the risk.
   ...
   <Frame>
     <img
       src="/images/docs/b71aa2a4f9bfa548150b8f7d1c8ac89126b3a661f60858efc6d232073020d4f3-Device_Reliability_Score2.jpg"
       alt=""
       className="mx-auto"
       style={{ width:"63%" }}
     />
